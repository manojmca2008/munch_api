...
class Utility 
{
    ...
    public function updateRestaurantDataMobile($response, $request) 
    {
        ...
        /*
         * Above Object can not be created right now as there is no restaurant module. As soon as the
        ...
        for ($i = 0; $i < $totalData; $i ++) {
            ...
            $open_now = rand(0,1) ;  //$calender->isRestaurantOpen($response ['data'] [$i] ['res_id']);
